...
public class PersonaDatasource implements JRDataSource{
	private List<PersonaReporte> listaPersonas = new ArrayList<PersonaReporte>();
	...
	public Object getFieldValue(JRField jrField) throws JRException {
		...
		if("nombre".equals(jrField.getName())){
			...
			valor = listaPersonas.get(indicePersonaReporteActual).getLocalidad();
		}else if("fechaCumple".equals(jrField.getName())){
			valor = listaPersonas.get(indicePersonaReporteActual).getFechaCumple();
		}else if("correoElectronico".equals(jrField.getName())){
			valor = listaPersonas.get(indicePersonaReporteActual).getCorreoElectronico();
		}else if("tipoContacto".equals(jrField.getName())){
			valor = listaPersonas.get(indicePersonaReporteActual).getTipoContacto();
